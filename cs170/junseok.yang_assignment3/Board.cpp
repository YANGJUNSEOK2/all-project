    ...
    namespace BattleShip {
        ...
        int Board::GetBoard(int value) const
        {
            ...
            case BoardValue::NUMBOAT:
                ...
                break;
            case BoardValue::SHOTRESULT:
                return Board::shotResult;
                break;
        ...
        void Board::SetBoard(int value, BoardValue board_value)
        {
            ...
            case BoardValue::SHOTRESULT:
                if (value == HIT)
                {
                    Board::shotResult = HIT;
                }
                else if (value == MISS)
                {
                    Board::shotResult = MISS;
                }
                else if (value == DUPLICATE)
                {
                    Board::shotResult = DUPLICATE;
                }
                else if (value == SUNK)
                {
                    Board::shotResult = SUNK;
                }
                else if (value == INVALID)
                {
                    Board::shotResult = INVALID;
                }
                break;
            default:
                break;
