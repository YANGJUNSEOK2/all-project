...
Room* Room0_Build()
{
	...
	Room_SetDescription(room, "This is room 0. It is a display room with a cage in the middle. You can see a jeweled egg inside the cage.  There is a crack in the west wall, but you can't fit it from this side.\nThere is also a path leading East.\n");

	Room_AddRoomExit(room, "path", 3);

	Room_AddRoomExitShortcut(room, "east", 3);
